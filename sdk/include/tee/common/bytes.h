#ifndef SDK_INCLUDE_TEE_COMMON_BYTES_H_
#define SDK_INCLUDE_TEE_COMMON_BYTES_H_
...
class DataBytes : public std::vector<uint8_t> {
 public:
  ...
  TeeErrorCode GetError() {
    if (empty() && (error_code_ == TEE_SUCCESS)) {
...
using DataBytes = tee::common::DataBytes;

#endif  // SDK_INCLUDE_TEE_COMMON_BYTES_H_
